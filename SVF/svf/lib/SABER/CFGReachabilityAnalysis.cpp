...
// static llvm::RegisterPass<CFGReachabilityAnalysis> X("x", "x");
...
// bool CFGReachabilityAnalysis::runOnModule(llvm::Module& M) {
// 	return false;
// }

// CFGReachability* CFGReachabilityAnalysis::getReachabilityResultFor(const llvm::Function* func)
// {
...
// bool CFGReachabilityAnalysis::isBBReachable(const llvm::BasicBlock *Src, const llvm::BasicBlock *Dst) {
//     assert(
...
// bool CFGReachabilityAnalysis::isReachableInBlock(const llvm::Instruction* Src,
...
// bool CFGReachabilityAnalysis::isReachable(const llvm::Instruction* Src, const llvm::Instruction* Dst) {
...
// CFGReachability::CFGReachability(const llvm::Function& F) :
...
// // destination node.
// void CFGReachability::mapReachability(const llvm::BasicBlock *Dst) {
...
// 		const llvm::BasicBlock *block = worklist.back();
// 		worklist.pop_back();
...
// 				++I) {
// 			const llvm::BasicBlock* pred_bb = *I;
// 			worklist.push_back(pred_bb);
// 		}
// 	}
// }

// bool CFGReachability::isReachable(const llvm::BasicBlock* Src, const llvm::BasicBlock* Dst) {
