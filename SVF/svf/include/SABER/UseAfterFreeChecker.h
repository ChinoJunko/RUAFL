...
//     void searchForward(const SVFGNode*, const SVFGNode*, const SVFGEdge*, std::vector<const SVFGEdge*>,const SVFInstruction*, bool);

//     void push();

//     void pop();

//     bool check(const SVFInstruction*);
...
//     void reportBug(const SVFInstruction*);

//     bool reachable(const SVFInstruction*, const SVFInstruction*);
