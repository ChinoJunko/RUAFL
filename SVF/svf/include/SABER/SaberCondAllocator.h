...
public:
    ...
    typedef Map<u32_t, const SVFBasicBlock*> CondToSuccBBMap;
    ...
    inline const SVFBasicBlock* getCondSuccBB(u32_t id){
        return condToSuccBBMap[id];
    }
...
private:
    ...
    CondToSuccBBMap condToSuccBBMap;
